...
(function () {
  ...
  function transformRowToClientJson(rowRaw) {
    ...
    // Common fields: titles and suffixes as arrays
    const titlesList = _to_string_list(row['titles']);
    if (titlesList !== null) clientData.titles = titlesList;

    const suffixesList = _to_string_list(row['suffixes']);
    if (suffixesList !== null) clientData.suffixes = suffixesList;
    ...
    // Assessment required and review fields
